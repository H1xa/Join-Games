...
client.on('message', message => {
    ...
    .setAuthor("[ Join Games ᴊɢ Bot ]", " https://images-ext-2.discordapp.net/external/ahNXTY5REo9rE5-6oa5XGyzSrJis3qbk7eBUv1sEiYI/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/459725014237970492/558a210e07b9ae2504e427a4c7c6d297.png?width=455&height=455")
    .addField("**[ Join Games ᴊɢ Prefix] :**","**[ + ]**" , true)
    .addField("** [ Join Games ᴊɢ ID ] **", "**"+"459725014237970492"+"**",true)
    .addField("** [ Join Games ᴊɢ ] **","** **")
